# PP Shifts Paper: Data from 1989-2014
# Ellen K. Bledsoe
# April 2019
...
# ggsave("figures/1989-2014/Figure1.png", plot1, width = 7, height = 3.5, dpi = 600)
# ggsave("figures/1989-2014/Figure1.tiff", plot1,
...
rmark_results <- read.csv("preliminary_work/data/MARKdata/MARK_SerenityRun/top_model_summary.csv", 
...
# ggsave("figures/1989-2014/Figure2.png", plot2, width = 6, height = 7, dpi = 600)
# ggsave("figures/1989-2014/Figure2.tiff", plot2,
...
# ggsave("figures/1989-2014/Figure3_energy.png", plot3_energy, width = 3.5, height = 3, dpi = 600)
